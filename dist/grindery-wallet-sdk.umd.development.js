(function (factory) {
  ...
  var ProviderLocalStorage = /*#__PURE__*/function (_ProviderEventEmitter) {
    function ProviderLocalStorage() {
      var _this;
      _this = _ProviderEventEmitter.call(this) || this;
      var userId = _this.getStorageValue('userId');
      if (!userId) {
        var _window$Telegram;
        _this.setStorageValue('userId', ((_window$Telegram = window.Telegram) == null || (_window$Telegram = _window$Telegram.WebApp) == null || (_window$Telegram = _window$Telegram.initDataUnsafe) == null || (_window$Telegram = _window$Telegram.user) == null ? void 0 : _window$Telegram.id) || '');
      }
      return _this;
    }
  ...
  var GrinderyWalletProvider = /*#__PURE__*/function (_ProviderLocalStorage) {
    function GrinderyWalletProvider() {
      ...
      _this.methods = {
        eth_accounts: function () {
          var _eth_accounts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_) {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  if (!(!_this.accessToken || _this.accounts.length === 0)) {
                    _context.next = 2;
                    break;
                  }
                  throw new ProviderError('Unauthorized', 4900);
                case 2:
                  return _context.abrupt("return", _this.accounts);
                case 3:
                case "end":
          ...
          function eth_accounts(_x) {
            return _eth_accounts.apply(this, arguments);
          }
          return eth_accounts;
        }(),
        eth_requestAccounts: function () {
          var _eth_requestAccounts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
            var result;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return _context2.abrupt("return", _this.accounts);
                case 2:
                  _context2.prev = 2;
                  _context2.next = 5;
                  return _this.sendGrinderyRpcApiRequest('pair', _extends({}, params, {
                    uri: _this.appData.uri,
                    userId: _this.getStorageValue('userId')
                  }));
                case 5:
                  result = _context2.sent;
                  if (!(result.success && result.address && new RegExp(/^0x[0-9a-fA-F]{40}$/).test(result.address))) {
                    _context2.next = 11;
                    break;
                  }
                  _this.setStorageValue('address', result.address);
                  _this.accounts = [result.address];
          ...
          function eth_requestAccounts(_x2) {
            return _eth_requestAccounts.apply(this, arguments);
          }
          return eth_requestAccounts;
        }(),
        eth_sendTransaction: function () {
          var _eth_sendTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  _context3.next = 4;
                  return _this.sendGrinderyRpcApiRequest('eth_sendTransaction', params);
                case 4:
          ...
          function eth_sendTransaction(_x3) {
    ...
    _proto.isAccountsConnected = function isAccountsConnected() {
      return this.accounts.length > 0;
    };
    _proto.request = /*#__PURE__*/function () {
      var _request = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref) {
        var method, params;
    ...
    _proto.connect = /*#__PURE__*/function () {
      var _connect = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var _this2 = this;
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              try {
                ...
                setTimeout(function () {
                  _this2.chainId = '0x89';
                  if (_this2.getStorageValue('address')) {
                    _this2.accounts = [_this2.getStorageValue('address')];
                  }
                  _this2.emit('connect', {
                ...
                this.emit('disconnect', {
                  error: this.createProviderRpcError(error)
                });
              }
            case 1:
            case "end":
    ...
    _proto.sendGrinderyRpcApiRequest = /*#__PURE__*/function () {
      var _sendGrinderyRpcApiRequest = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(method, params) {
        var response, data;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 14:
              ...
              throw this.createProviderRpcError(_context6.t0);
            case 17:
            case "end":
      ...
      function sendGrinderyRpcApiRequest(_x5, _x6) {
